    ...
    export default {
        ...
        methods: {
            ...
            submit (name, index) {
                ...
                let body = {source: ''}
                body['source'] = trim(this.formCustom[name])
                if (name === 'sex') {
                    body['source'] = parseInt(body['source'])
                }
                request.updateInfo({
                    params: {
                        type: name
            ...
            addSchool () {
                ...
                request.schoolAdd({
                    ...
                    if (res.status === ErrorCode.SUCCESS) {
                        ...
                        this.userInfo.schools.push(res.data.school)
                        this.close('school', 4)
                    } else {
                        this.$Message.error({
                            duration: config.messageDuration,
            ...
            addCareer () {
                ...
                request.careerAdd({
                    ...
                    if (res.status === ErrorCode.SUCCESS) {
                        ...
                        this.userInfo.careers.push(res.data.career)
                        this.close('career', 5)
                    } else {
                        this.$Message.error({
                            duration: config.messageDuration,
