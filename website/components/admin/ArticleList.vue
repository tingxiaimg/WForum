    ...
    export default {
                ...
                },
                {
                    ...
                    render: (h, obj) => {
                        return (
                            h('a', {
                                'class': 'article-item-name',
                                'style': obj.row.status === 2 ? 'color: red' : obj.row.status === 0 ? 'color: #02ff2f' : '',
                                attrs: {
                                    href: '/topic/' + obj.row.id,
                                    target: '_blank'
                                }
        ...
        methods: {
            onSelectChange (value) {
                window.location.href = `/admin/topic/${this.path}?cate=${value}`
            },
            onPageChange (value) {
                window.location.href = `/admin/topic/${this.path}?cate=${this.cate}&pageNo=${value}`
            },
